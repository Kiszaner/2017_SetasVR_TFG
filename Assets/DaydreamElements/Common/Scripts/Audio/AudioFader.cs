...
namespace DaydreamElements.Common {
  ...
  public class AudioFader : MonoBehaviour {
    ...
    private ResonanceAudioSource audioSource;

    private const float SIMILARITY_THRESHOLD = 0.01f;

    public bool IsFading {
      get {
        return audioSource.audioSource.volume != targetVolume;
      }
    }
    ...
    void Awake() {
  	...
  	void Update() {
      float currentVolume = audioSource.audioSource.volume;
      ...
      audioSource.audioSource.volume = currentVolume;
  	}
  }
}